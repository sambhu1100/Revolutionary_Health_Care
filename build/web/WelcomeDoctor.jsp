...
<%
    ArrayList<doctorModel> data=(ArrayList<doctorModel>)request.getAttribute("doctorList");
            ...
            <div class="d-flex  flex-column flex-lg-row align-items-center w-100 justify-content-between">
              <ul class="navbar-nav  ">
                ...
                <li>
                    <p>
                    <h6>
                        <b style="color: yellow">Doctor Email  :  </b>
                    </h6>
                    </p>
                </li>
                <li>
                    ...
                    <table id="patient">
                        ...
                        for(PatientModel p:pList){
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="submit" class="button1" formaction="patientDetails2?id=<%=p.getEmail()%>">Proceed</button>
