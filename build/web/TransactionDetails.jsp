...
<%
    ArrayList<MedicalCard> data=(ArrayList<MedicalCard>)request.getAttribute("data");
%>
<!DOCTYPE html>
<html>
    <head>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex  flex-column flex-lg-row align-items-center w-100 justify-content-between">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="doctorRegistration.jsp">New Doctor</a>
                </li>
              </ul>
          ...
          <div class="carousel-item active">
            <div class="container">
              <div class="row">
                ...
                <center>
                    <form>
                    <table width="500" bgcolor="#33FFA5" border="">
                        <tr>
                            <td colspan="3" align="center" style="color: #004085"><h3>Transaction History</h3></td>
                        </tr>
                        <tr>
                            <th>
                                Registered Email
