                ...
                <center>
                    ...
                    <table id="patient">
                        <tr>
                            ...
                            <h3 style="color: yellow">Prescription</h3>
                            </th>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" name="tb_email2">
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" name="tbDisease" required="">
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" name="tbFirstOccur" required="">
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" name="tbMedicine" required="">
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
