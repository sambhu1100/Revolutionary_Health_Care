          ...
          <div class="carousel-item active">
            <div class="container">
              <div class="row">
                ...
                <center>
                    <form method="post" action="medicalData">
                    <table id="patient">
                        <tr>
                            <th colspan="2">
                            <h3 style="color:yellow">Fill-up Medical Data for Online Consultation</h3>
                            </th>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <%=email%>
                                <input type="hidden" name="tb_email" value="<%=email%>">
                            </td>
                        </tr>
                        <tr>
                            <td>
                                Tell us about the disease/illness
                            </td>
                            <td>
                                <input type="textarea" name="tb_disease" rows="4" cols="50" required="">
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" name="tb_time_occurrence" required="">
                            </td>
                        </tr>
                        <tr>
                            <td>
                                Any medicine if is being continuing
                            </td>
                            <td>
                        ...
                        <tr>
                            <td colspan="2" align="center" class="button3">
