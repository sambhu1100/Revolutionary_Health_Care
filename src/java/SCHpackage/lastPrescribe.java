 ...
 * @author HP
 */
@WebServlet(name = "lastPrescribe", urlPatterns = {"/lastPrescribe"})
public class lastPrescribe extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet lastPrescribe</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet lastPrescribe at " + request.getContextPath() + "</h1>");
