      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <form method="post" action="PatientRegistration">
                <center>
                    <table>
                        <tr>
                            <td colspan="2" align="center" style="background: #062c33; color: white;" border="1">
                            <h3>New Patient</h3>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="tb_name" maxlength="30" required="">
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="tb_dob" maxlength="30" required="" value="YYYY/MM/DD">
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="tb_guardian" maxlength="30" required="">
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" name="tb_occupation" maxlength="30" required="">
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" name="tb_mark" maxlength="30" required="">
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="tb_aadhar" required="" maxlength="12">
                            </td>
                        </tr>
                        <!--tr>
                            <td>
                        ...
                        <tr>
                            <td colspan="2" align="center">
                                <button type="submit" name="btn_submit" onclick="return checkPassword()">Sign Up</button>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
